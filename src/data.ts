...
export const projects: Project[] = [
  ...
  },
  {
    ...
    name: "工业水泵智能控制与运维平台",
    category: "工作案例",
    type: "IoT / B端复杂系统 / 商业产品",
    value: "从设备控制工具升级为面向工业水泵运营的 IoT 管理平台，完成用户权限、设备生命周期、远程控制及售后闭环设计。",
    role: "产品规划 & 交互设计",
    archive: {
      start: "经销商无法管理设备，转交场景复杂，售后人员权限不足",
      iteration: "从单一设备控制，升级为设备资产、用户权限和售后闭环一体化平台",
      current: "脱敏产品案例整理完成"
    },
    status: "脱敏案例",
    actions: [
    ...
    humanNote: "不是只做远程开关，而是把设备资产、用户关系和售后服务接成闭环。",
    summary: "工业水泵智能控制与运维平台：从客户定制项目到自主设备管理平台的产品设计。",
    why: "基于已有水泵控制器硬件能力，规划自主化智能控制与运维平台，解决设备归属、跨角色协作和故障处理链路长的问题。",
    problem: "经销商无法管理设备，转交场景复杂，售后人员权限不足；传统水泵故障处理链路长，异常发现、任务分配、处理反馈和关闭缺少统一闭环。",
    solution: "以设备作为核心资产，建立设备 → 主用户 → 子用户 → 经销商的关系模型，并围绕生产 → 部署 → 使用 → 维护规划全生命周期管理。",
    features: ["多角色权限体系", "扫码绑定 / 解绑 / 转移", "设备运行监测", "远程启停与参数控制", "售后工单闭环", "Web 管理后台"],
    contribution: ["梳理水泵设备管理业务流程，完成移动端与管理后台的信息架构设计", "以设备为核心资产，设计设备、主用户、子用户、经销商之间的关系模型", "建立多角色权限体系，解决经销商管理、设备转交和售后权限不足问题", "优化设备扫码绑定及归属流程，解决设备交付后的管理问题", "设计异常发现、任务分配、处理反馈到关闭的售后闭环", "输出 Axure / 原型方案，推动研发实现产品 1.0 版本"],
    progress: "已整理成脱敏产品案例，重点展示 IoT 产品化设计，不展示真实客户数据和内部配置。",
    next: ["补充平台架构图", "完善多角色权限示意", "整理面试演示路径", "后续探索异常预测、能耗优化和智能调控"]
  },
  {
    id: "yuanjing-miniapp",
    name: "元井小程序/界面案例",
