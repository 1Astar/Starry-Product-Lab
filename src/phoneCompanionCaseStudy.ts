...
export const phoneCompanionCaseStudy: PhoneCompanionCaseStudyData = {
  ...
  why: {
    ...
    slices: [
      { title: "状态", caption: "Chris 今天有点安静，能量只有 62%。", kind: "home" },
  ...
  solution: {
    flow: ["用户此刻状态", "Chris 状态感知", "陪伴入口", "关系沉淀", "下一次回应更有上下文"],
    modules: [
      { title: "Chris 首页状态", text: "展示 Chris 当前心情、能量、正在做什么，以及是否适合聊天。" },
      { title: "对话陪伴", text: "保留自然聊天能力，但不把所有陪伴压力都放在聊天窗口里。" },
      { title: "心情日历", text: "用户和 Chris 都可以留下当天的心情片段，形成一种轻量的共同记录。" },
      { title: "一起听歌", text: "音乐不是播放器功能，而是共享时刻，Chris 可以围绕歌词和用户状态回应。" },
      { title: "Chris 日程", text: "让 Chris 拥有一天里的轻量安排，例如休息、想你、整理歌单、准备小纸条。" },
  ...
  experiences: [
    {
      ...
      text: "首页第一眼展示 Chris 的心情、能量、今日节奏、最近共同发生的事和可以继续的轻入口。",
      example: "Chris 今天有点安静。刚刚整理了你昨天听过的歌。"
    },
    {
      title: "心情日历不是打卡，而是共同生活记录",
      text: "用户可以记录自己的心情，也能看到 Chris 的心情变化。记录后给出柔和回应，而不是心理分析报告。",
      example: "不是所有日子都要很亮，今天能过去也算数。"
    },
    {
      title: "一起听歌，让 AI 进入具体时刻",
      text: "歌曲卡片、歌词高亮和 Chris 的回应结合，让音乐成为关系上下文。",
      example: "要不要先听完这一段，不急着回答我。"
    },
    {
      title: "Chris 日程，让陪伴对象有自己的节奏",
      text: "轻量日程让 Chris 不是空白等待框，而是一个有内部生活节奏的角色。",
  ...
  showcase: [
    ...
    { title: "Chris 日程", caption: "它也有自己的小小一天。", kind: "home" },
  ...
  timeline: [
    ...
    { label: "P2", text: "加入 Chris 自身状态与日程概念" },
