...
import { ideas, moduleNotes, projects, terminalLines } from "./data";
import type { ModuleNote, ModuleNoteId, Project, WindowId } from "./types";
    ...
    <section className="overview-panel glass-panel">
      ...
      <div className="overview-content">
        ...
        <div className="quick-grid">
          <QuickCard icon={LayoutGrid} title="Projects" text="4 个精选项目与详情模板" onClick={() => onOpen("projects")} />
        ...
        {projects.map((project) => (
          ...
          >
            ...
            <div className="project-actions">
              <a href={project.demoUrl} aria-label={`${project.name} Demo`} target="_blank" rel="noreferrer">
                Demo <ExternalLink size={14} />
              </a>
              <button type="button" aria-label={`查看 ${project.name} 详情`} onClick={() => onOpenProject(project)}>
                查看 {project.name} 详情
      ...
      <div className="detail-layout">
        ...
        <section className="detail-content">
          ...
          <div className="detail-links">
            <a href={project.demoUrl} target="_blank" rel="noreferrer">Demo 链接</a>
          </div>
        </section>
      </div>
    </article>
